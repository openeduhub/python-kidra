...
#+begin_src sh
nix run "git+https://scm.edu-sharing.com/edu-sharing/projects/wlo/python-kidra?ref=additional-services#docker.copyToDockerDaemon"
#+end_src
or
#+begin_src sh
nix run "git+https://scm.edu-sharing.com/edu-sharing/projects/wlo/python-kidra?ref=additional-services#docker.copyToPodman"
#+end_src
...
#+begin_src sh
git clone -b additional-services https://scm.edu-sharing.com/edu-sharing/projects/wlo/python-kidra
cd python-kidra
sh build.sh
#+end_src
...
#+begin_src sh
nix run "git+https://scm.edu-sharing.com/edu-sharing/projects/wlo/python-kidra?ref=additional-services"
#+end_src
...
Once the service is running, an interface listing all of the available end-points and their documentation is available at [[http://localhost:8080/docs]].
